...
{
public:
	ISceneNode(ISceneNode *parent, CSceneManager *mgr) : m_Parent(parent), m_SceneManager(mgr), m_RelativeTranslation(glm::fvec3(0,0,0)), m_RelativeRotation(glm::fvec3(0,0,0))
	{
		if (parent)
